	...
	<div class="container" style="padding: 20px;">
		<div class="fixed-action-btn toolbar">
			...
			<ul>
			  ...
			  <li class="waves-effect waves-light"><a href="./index.html"><i class="material-icons">input</i></a></li> 
			</ul>
		</div>
				...
				<div class="card z-depth-5">
					...
					<div class="card-content">
						<div class="row">
							<div class="col s12">
								<div class="right">
									<a href="./miGraficaEncuesta.html"  class="waves-effect waves-light btn orange">Ir a Gráfica <i class="material-icons left">insert_chart</i></a>
						...
						<div class="row">
							<div class="col s12">
								<table class="highlight bordered striped" style="margin-bottom: 15px;"  id="reporte">
									<thead>
									  <tr>
									  	  <th>SUCURSAL</th>
									      <th>DETESTABLE</th>
			...
			$.ajax({
				...
				success: function(json) {
					...
					json.forEach(function(v) {
						$('#tbody').append('<tr>id="tableEnSucursal"<td>'+ v.sucursal +'</td><td id="tableDetestable'+v.id_sucursal+'">0</td><td id="tableMalo'+v.id_sucursal+'">0</td><td id="tableRegular'+v.id_sucursal+'">0</td><td id="tableBien'+v.id_sucursal+'">0</td><td id="tableExcelente'+v.id_sucursal+'">0</td><td td></tr>');
